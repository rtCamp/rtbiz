	...
	<div class="rt-biz-container">
		<ul class="rt_biz_acl_other_option subsubsub">
			...
			<?php foreach( $department as $ug ){ ?>
				<li><a href="<?php admin_url( 'edit-tags.php?action=edit&taxonomy=' . RT_Departments::$slug . '&tag_ID=' . $ug->term_id . '&post_type=' . rt_biz_get_contact_post_type() ) ?>" class=""><?php echo $ug->name; ?></a></li> |
			<?php } ?>
