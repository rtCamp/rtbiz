...
class Test_Rt_company extends RT_WP_TestCase {
	...
	function test_primary_email(){
		...
		$this->assertEquals( false, biz_is_primary_email_unique_company( '221b_backer@street.com' ) );
		$this->assertEquals( true, biz_is_primary_email_unique_company( 'james_moriart@woman.com' ) );
	}
}
