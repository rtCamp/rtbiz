...
class Test_Rt_Dashboard extends RT_WP_TestCase  {
	...
	function test_method_exists(){
		...
		$this->assertTrue( method_exists( $this->dashboard, 'rtbiz_dashboard_recent_posts' ), 'method rtbiz_dashboard_recent_posts does not exist in Rtbiz_Dashboard' );
		$this->assertTrue( method_exists( $this->dashboard, 'rtbiz_dashboard_recent_comments_row' ), 'method rtbiz_dashboard_recent_comments_row does not exist in Rtbiz_Dashboard' );
		$this->assertTrue( method_exists( $this->dashboard, 'rtbiz_dashboard_recent_comments' ), 'method rtbiz_dashboard_recent_comments does not exist in Rtbiz_Dashboard' );
		$this->assertTrue( method_exists( $this->dashboard, 'rtbiz_dashboard_site_activity' ), 'method rtbiz_dashboard_site_activity does not exist in Rtbiz_Dashboard' );
