/**
 * Add regex escape function to RegExp class
 * @see https://github.com/IonicaBizau/regex-escape.js/blob/master/lib/index.js
 */
 ...
 *
 * @name RtBizRegexEscape
 * @function
 * @param {String} input The string that must be escaped.
 * @return {String} The escaped string.
 */
function RtBizRegexEscape(input) {
    // Ensure input is a string before calling replace to avoid runtime errors.
 ...
 * Adds the `RtBizRegexEscape` function to `RegExp` class.
 *
 * @name RegExpEscapePolyfill
 * @function
 * @return {Function} The `RtBizRegexEscape` function.
 */
if (!RegExp.escape) {
	RegExp.escape = RtBizRegexEscape;
}

jQuery(document).ready(function () {
	const { adminurl } = rtmailbox_data;
